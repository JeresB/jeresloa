            ...
            <div className="flex flex-col items-center mb-2 p-2 border rounded-lg text-gray-300 bg-gray-800 border-gray-700">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700 mt-2">
                    <div className="bg-blue-600 h-2.5 rounded-full" style={{
                        width: `${
                            userLevelingObj.user.experience_points < 4800 ? (userLevelingObj.user.experience_points / 4800) * 100 :
                ...
                <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700 mt-2">
                    <div className="bg-green-600 h-2.5 rounded-full" style={{
                        width: `${
                            (Math.round(((userLevelingObj.user.experience_points - ((Math.floor((userLevelingObj.user.experience_points * 100) / 76800) * 76800) / 100)) * 100) / (((Math.ceil((userLevelingObj.user.experience_points * 100) / 76800) * 76800) / 100) - ((Math.floor((userLevelingObj.user.experience_points * 100) / 76800) * 76800) / 100))))
                        }%`
                    }}></div>
                </div>
            </div>
